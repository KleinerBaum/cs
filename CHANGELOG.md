...
- Hardened LLM integrations with JSON Schema validation and fail-closed handling
  for extraction, fill-missing, and translation outputs so malformed payloads
  are logged and dropped before updating the profile state.
