...
_STRINGS: dict[str, dict[str, str]] = {
    LANG_DE: {
        ...
        "intake.subtitle": "URL oder PDF/DOCX hochladen, um so viele Felder wie möglich automatisch zu prefillen.",
        ...
        "intake.need_source": "Bitte URL oder Datei angeben (oder einfach weiterklicken und manuell ausfüllen).",
    ...
    LANG_EN: {
        ...
        "intake.subtitle": "Paste a URL or upload a PDF/DOCX to prefill as many fields as possible.",
        "intake.url": "Job ad URL (optional)",
        "intake.file": "PDF/DOCX upload (optional)",
        ...
        "intake.need_source": "Please provide a URL or file (or just continue and fill everything manually).",
...
_OPTION_LABELS: dict[str, dict[str, dict[str, str]]] = {
    ...
    "employment_type": {
        LANG_DE: {"full_time": "Vollzeit", "part_time": "Teilzeit", "contractor": "Freelance/Contractor", "intern": "Praktikum"},
        LANG_EN: {"full_time": "Full-time", "part_time": "Part-time", "contractor": "Contractor", "intern": "Internship"},
    },
    "contract_type": {
